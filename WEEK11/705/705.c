...
int8 dem = 0;
float temp = 0, lm35a = 0, temp1 = 0, lm35b = 0;
int try = 0;
int1 ttqn = 0;
float M,N;
...
void giai_ma(){
   ...
   printf(lcd_data,"%.1f",lm35a);
   printf(lcd_data," %.1f",lm35b);
}
...
void read_temp(){
         ...
         if (try == 2) {
            ...
            temp = 0;
            temp1 = 0;
            unsigned int temperature1 = lm35a;
            unsigned int temperature2 = lm35b;            
            xuat_4led_7doan_4so(ma7doan[temperature1/10],ma7doan[temperature1%10],ma7doan[temperature2/10],ma7doan[temperature2%10]);
            }
}

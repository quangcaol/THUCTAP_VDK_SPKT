...
void main()
{
   ...
   while(TRUE)
   {
      if (bdn<10) {
         ...
         if(ttct_td==2) sang_tat_dan_ngoai_vao_32led(10,0);
         if(ttct_td==3) sang_don_pst_32led(10,0);
         if(ttct_td==4) sang_tat_dan_pst_32led(10,1);
         if(ttct_td==5) sang_tat_dan_phai_sang_trai_2x16led(10,0);
         if(ttct_td==6) sang_don_pst_32led(10,0);
         if(ttct_td==7) sang_don_pst_32led(10,0);
         if(ttct_td==8) sang_tat_32led(10,0);
         if(ttct_td==9) sang_tat_dan_ngoai_vao_32led(10,0);
